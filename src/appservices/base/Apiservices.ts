...
import { ISourceResults } from "../interface/ISourceResults";
import { INewsResults } from "../interface/INewsResults";
...
export default class apiservices {
    ...
    // Get Sources
    public static async getSources(apiKey:string):Promise<ISourceResults>{
